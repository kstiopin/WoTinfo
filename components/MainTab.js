...
export class MainTab extends Component {
  ...
  toggleAccounts = () => this.setState(prevState => {
    if (!prevState.showAccounts) {
    ...
    return { showAccounts: !prevState.showAccounts };
  })
  ...
  render() {
    ...
    return (
      <div className='l-page nationTree' id='main'>
        ...
        <div id='other_requests'>
          <div className='flex-row top-line'>
            ...
            <a href={ `${apiUrl}auth/login/${applicationId}&redirect_uri=http://wot.kstiopin.in.ua/` }>Авторизироваться для обновления техники в ангаре</a>
          </div>
